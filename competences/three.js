...
// scene.add(cube)
let oeil;
loader.load("../Assets/3D/modele.gltf", function (gltf) {
  oeil = gltf.scene;
...
let eyelid;
loader.load("../Assets/3D/modeleEyelid.gltf", function (gltf) {
  eyelid = gltf.scene;
...
function animate() {
  ...
  // if (pageChange) {
  //   oeil.position.z = oeil.position.z - 15
  // }

  if (oeil != null && eyelid != null) {
    oeil.lookAt(target);
